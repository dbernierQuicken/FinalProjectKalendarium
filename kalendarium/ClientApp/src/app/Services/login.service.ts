...
export class LoginService {
  ...
  GetAllUsers(cb) {
    ...
    myformdata.append('dPart', dPart);
    myformdata.append('pWord', pWord);
    this.http.post<any>(`/user/isuser`, myformdata, {}).subscribe(results => {
      console.log(results);
      this.isuser = results;
    });
    ...
    this.http.post<any>(`/coworker/add`, myformdata, {}).subscribe(results => {
      console.log(results);
    });
    ...
    myformdata.append('coworkerid', coworkerid);
    this.http.post<any>(`/coworker/toggle`, myformdata, {}).subscribe(results => {
      console.log(results);
    });
  }
}
